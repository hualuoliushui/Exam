...
,typename... Args\
>\
struct function_traits<std::function<ReturnType(ClassType::*)(Args...) __VA_ARGS__>\
...
struct fucntion_traits
	:function_traits<decltype(&Callable::operator())>
{};

// lambda
template<typename Function>
typename fucntion_traits<Function>::stdl_function_type
